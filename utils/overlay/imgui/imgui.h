...
namespace ImGui
{
    ...
    inline bool Renderingtab(const char* icon, bool selected);
    inline bool Renderingsubtab(const char* icon, bool selected);
    ...
    IMGUI_API const char*   GetKeyName(ImGuiKey key);                                           // [+] returns English name of the key. Those names a provided for debugging purpose and are not meant to be saved persistently not compared.
