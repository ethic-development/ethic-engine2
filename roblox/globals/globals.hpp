...
struct globals
{
	static ethic::roblox::instance_t datamodel;
	static ethic::roblox::instance_t visualengine;
	static ethic::roblox::instance_t players;
	static ethic::roblox::instance_t placeid;
//	static ethic::roblox::instance_t camera;
	//static ethic::roblox::instance_t pf;
	...
	static ethic::LuaVM luaVM; // lua env
};